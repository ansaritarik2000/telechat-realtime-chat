      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            ...
            total: {
              show: true,
              label: `${totalOpenCredits}/${totalSubmittedCredits} Open Rate`,
              color: "#17c964",
              fontSize: "0.75rem",
              fontWeight: "500",
              fontFamily: "&quot;Public Sans Variable&quot",
