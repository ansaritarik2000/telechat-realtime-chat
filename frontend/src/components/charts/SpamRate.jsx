...
const SpamRateChart = () => {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            ...
            total: {
              show: true,
              label: `${totalSpamCredits}/${totalSubmittedCredits} Spam Rate`,
              color: "#D32F2F",
              fontSize: "0.75rem",
              fontWeight: "500",
              fontFamily: "&quot;Public Sans Variable&quot",
  ...
  return <div ref={chartRef} style={{ margin: 0 }} />;
};

export default SpamRateChart;
