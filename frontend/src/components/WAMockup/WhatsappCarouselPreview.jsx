...
import { QuickReplyIcon, CopyIcon,PhoneNumberIcon,ExternalLinkIcon } from "../../utils/ReusableIcons";
import ActionButton from "./ActionButton";
const WhatsappCarouselPreview = () => {
  const { carouselItems, currentSlide, setCurrentSlide, carouselBodyContent,carouelType} =
    useWhatsappTemplateStore();
 
  // console.log("carouelType",carouelType)
