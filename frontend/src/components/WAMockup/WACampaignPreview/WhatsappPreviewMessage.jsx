...
const WhatsappPreviewMessage = ({ template_contents }) => {
    ...
    const bodyContent = singleTemplateData[0]?.["textMessageContent"]
    const headerContents = singleTemplateData[0]?.["headerContent"]
    return (
        <>
            <div>
                {" "}
                ...
                <p className="text-sm font-bold text-gray-900 break-all">
                    { headerContents?.textMessage }
               </p>

                <p className="text-semibold text-sm break-all">
                   
                      {  bodyContent?.textMessage}
                </p>
