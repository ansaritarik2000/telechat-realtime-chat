...
export const getWeeklyReport = async (startDate, endDate) => {
    try {
        const response = await axiosServerInstance.get(`/sms/weekly-report`, {
            params: {
                startDate,
                endDate,
            },
...
export const getHourlyReport = async (date) => {
    try {
        const response = await axiosServerInstance.get(`/sms/hourly-report`, {
            params: {
                date,
            },
        });
...
export const getYearlyReport = async (year) => {
    try {
        const response = await axiosServerInstance.get(`/sms/yearly-report`, {
            params: {
                year,
            },
        });
