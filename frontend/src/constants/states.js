export const states = [
  { key: "andaman_nicobar", label: "Andaman and Nicobar Islands" },
  { key: "andhra_pradesh", label: "Andhra Pradesh" },
  { key: "arunachal_pradesh", label: "Arunachal Pradesh" },
  { key: "assam", label: "Assam" },
  { key: "bihar", label: "Bihar" },
  { key: "chandigarh", label: "Chandigarh" },
  { key: "chhattisgarh", label: "Chhattisgarh" },
  { key: "dadra_nagar_haveli", label: "Dadra and Nagar Haveli" },
  { key: "daman_diu", label: "Daman and Diu" },
  { key: "delhi", label: "Delhi" },
  { key: "goa", label: "Goa" },
  { key: "gujarat", label: "Gujarat" },
  { key: "haryana", label: "Haryana" },
  { key: "himachal_pradesh", label: "Himachal Pradesh" },
  { key: "jammu_kashmir", label: "Jammu and Kashmir" },
