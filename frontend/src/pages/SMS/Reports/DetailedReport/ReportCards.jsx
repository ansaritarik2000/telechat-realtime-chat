...
import { getSmsDetailsStats } from "../../../../services/Sms/getSmsStatsService";
...
export default function ReportCards() {
    ...
    // this use effect are used for get sms stats data
    useEffect(() => {
        if (campaign_id) {
            const fetchData = async () => {
                try {
                    const response = await getSmsDetailsStats(campaign_id);
    ...
    return (
        <div className="w-full flex gap-4">
            {/* Success Card */}
            <div className="w-1/4 bg-gradient-to-r from-primary-50 to-primary-100 border border-primary-200 rounded-md px-8 py-8 flex items-center justify-between shadow-lg relative">
                <div className="flex flex-col gap-4">
                    <h1 className="font-semibold text-md text-primary-900">
                        {t("Submitted Campaigns")}
                    </h1>
            ...
            {/* Delivered Card */}
            <div className="w-1/4 bg-gradient-to-r from-success-50 to-success-100 border border-success-200 rounded-md px-8 py-8 flex items-center justify-between shadow-lg relative">
                <div className="flex flex-col gap-4">
                    <h1 className="font-semibold text-md text-success-900">
                        {t("Delivered Campaigns")}
                    </h1>
            ...
            {/* Failed Card */}
            <div className="w-1/4 bg-gradient-to-r from-danger-50 to-danger-100 border border-danger-200 rounded-md px-8 py-8 flex items-center justify-between shadow-lg relative">
                <div className="flex flex-col gap-4">
            ...
            {/* Awaited Card */}
            <div className="w-1/4 bg-gradient-to-r from-warning-50 to-warning-100 border border-warning-200 rounded-md px-8 py-8 flex items-center justify-between shadow-lg relative">
                <div className="flex flex-col gap-4">
