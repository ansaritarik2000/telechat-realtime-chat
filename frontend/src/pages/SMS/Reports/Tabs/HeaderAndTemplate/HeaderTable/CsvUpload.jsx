...
const CsvUpload = () => {
    // zustand store
    const { file, setFile } = useSmsHeaderStore();
        ...
        <div className="w-full flex">
          ...
          Click to upload or drag & drop the file
                ...
                {!file && (
                    <div>
                        <div
                            className="w-full h-32 border-dashed border-2 border-success-200 rounded-lg flex flex-col items-center justify-center relative bg-gray-50 dark:bg-content1"
