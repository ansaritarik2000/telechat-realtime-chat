...
export default function RangeCal({ hasRangeCal }) {
  let defaultDate = {
    start: undefined,
    end: undefined,
  };
  ...
  const handleRangeChange = (newRange) => {
    setValue((prev) => ({
      ...
      end: newRange.end || prev.end, // Update end if provided
    }));
  };
        ...
        CalendarBottomContent={
          <RadioGroup
            ...
            classNames={{
              base: "w-full pb-2",
              wrapper:
                "-my-2.5 py-2.5 px-3 gap-1 flex-nowrap max-w-[calc(var(--visible-months)_*_var(--calendar-width))] overflow-scroll",
            }}
