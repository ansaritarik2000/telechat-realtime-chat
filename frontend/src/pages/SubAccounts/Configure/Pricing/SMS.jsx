...
export default function SMSService() {
    const [selectedRadio, setSelectedRadio] = useState("prepaid");
    const {
        sms_promo_credits,
    ...
    return (
        ...
        <Input
          ...
          value={sms_global_credits}
          onChange={(e) => setSmsGlobalCredits(e.target.value)}
          type="text"
          size="sm"
          variant="flat"
          className="w-1/2"
        ...
        <BillingOn
          creditsType="global"
          value={sms_global_credits_billing_on}
          onChange={(e) => setSmsGlobalCreditsBillingOn(e.target.value)}
        />
      </div> */}
        </div>
    );
