...
const LoadingSkeleton = () => (
    ...
    >
        <div
            className={"flex w-full flex-col p-6 lg:w-[220px] lg:px-4 lg:pt-8"}
        >
...
export default function CalendarBookingIndex() {
    const [isLoading, setIsLoading] = useState(true);
    const [calendarBookingStep, setCalendarBookingStep] =
        useState("booking_initial");
    ...
    const onTimeChange = (time, selectedTimeSlotRange) => {
        if (selectedTimeSlotRange)
            setSelectedTimeSlotRange(selectedTimeSlotRange);
        ...
        <div className="flex w-[393px] flex-col items-center gap-5 rounded-large bg-default-50 shadow-small lg:w-fit lg:flex-row lg:items-start lg:px-6">
            ...
            <Calendar
                ...
                classNames={{
                    ...
                    gridHeaderCell:
                        "font-medium text-default-400 text-xs p-0 w-full",
            ...
            <CalendarTimeSelect
                ...
                weekday={format(selectedDate.toString(), "EEE", {
                    locale: enUS,
                })}
                onConfirm={onConfirm}
