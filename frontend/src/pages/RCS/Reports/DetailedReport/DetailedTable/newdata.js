// Campaign Name | Date | Campaign Size | Campaign Type | Status| Sent | Submitted | Delivered | Read | Failed | Cost |
...
const columns = [
    ...
    { name: "Bot Id", uid: "bot_id", sortable: true },
    { name: "Date & Time", uid: "date", sortable: true },
    { name: "Campaign Type", uid: "campaign_type", sortable: true },
...
//   { name: "ReceivedTS", uid: "received_at", sortable: true },
//   { name: "SubmitTS", uid: "submitted_at", sortable: true },
//   { name: "DeliveryTS", uid: "delivered_at", sortable: true },
