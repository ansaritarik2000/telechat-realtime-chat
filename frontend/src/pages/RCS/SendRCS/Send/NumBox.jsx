...
export default function NumberBox() {
  ...
  const processInput = (input) => {
    ...
    if (validNumbers.length > 0) {
      const updatedNumbers = [...new Set([...phoneNumbers, ...validNumbers])]; // Remove duplicates
  ...
  return (
    <div>
      <Textarea
        ...
        placeholder={`Enter numbers in the format:\n9876543210\n+919876543210\n\nUse commas or press Enter to add numbers.`}
