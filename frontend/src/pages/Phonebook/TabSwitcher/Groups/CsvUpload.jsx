...
const CsvUpload = () => {
    const { groupFile: file, setGroupFile: setFile } = usePhoneBookStore();
    ...
    return (
        <div className="w-full flex">
            <form
                ...
                {/* <span className="text-xs text-default-500 mb-4">Upload Contacts</span> */}
                {/* <p className="text-gray-600 mb-4">
          Click to upload or drag & drop the file
        </p> */}
                <div
                    className="w-full h-32 border-dashed border-2 border-success-200 rounded-lg flex flex-col items-center justify-center relative bg-gray-50 dark:bg-background"
                ...
                <div className="mt-4 text-gray-600 flex justify-end">
                    {/* <div>
