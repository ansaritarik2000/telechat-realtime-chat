...
export default function TimerModal({ path, onClose }) {
    const [time, setTime] = useState(10); // Timer for redirection
    ...
    const steps = [
        "Submitting template for review to WhatsApp.",
        "Ensuring compliance & submitting to WhatsApp for review.",
    ...
    return (
        <>
            ...
            >
                <ModalContent>
                    <ModalHeader>Processing your request...</ModalHeader>
                    <ModalBody>
                            ...
                            <div className="flex justify-center items-center flex-col ">
                                <p className="text-sm text-default-500">
                                    {redirectTimerStarted
                                        ? `Redirecting you to the next page in ${time} seconds...`
                                        : ""}
                                </p>
