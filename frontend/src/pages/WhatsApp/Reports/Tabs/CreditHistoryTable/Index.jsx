...
import { downloadWADetailsPDFservice } from "../../../../../services/Whatsapp/campaign/credit/creditHistoryDownloadServices";
...
export default function CreditsHistoryTable({ hasRangeCal }) {
  ...
  const exportToPDF = async() => {
    try {
      await downloadWADetailsPDFservice(); // Export RCS details PDF
  } catch (error) {
      addToast({
  ...
  const exportToCSV = () => {
    ...
    link.href = url;
    link.download = "creditHistory-Report.csv"; // Filename for the CSV
  ...
  return (
    ...
    >
      ...
      <TableBody emptyContent={"No credit found"} items={sortedItems}>
        {(item) => (
